...
class NN:
	...
	def backwards(self,x,target):
		...
		delta1_cedge = delta1[:,WEIGHT_DISTRIBUTION*5:WEIGHT_DISTRIBUTION*6]
		...
		dwedge = self.cedge.T @ delta1_cedge
		# full gradiant
		return dwe,dwl,dwr,dwu,dwd,dwedge,db1,dw2,db2


	def train(self,x,target):
		self.forward(x)
		dwe,dwl,dwr,dwu,dwd,dwedge,db1,dw2,db2 = self.backwards(x,target)
	...
	def save_network(self):
		...
		np.savez(FILE_NAME,self.w_e,self.w_l,self.w_r,self.w_u,self.w_d,self.w_edge,self.w_2,self.b_1,self.b_2)
		_ = outfile.seek(0)
	...
	def load_network(self):
		...
		self.w_2 = npzfile['arr_6']
		self.b_1 = npzfile['arr_7']
		self.b_2 = npzfile['arr_8']
